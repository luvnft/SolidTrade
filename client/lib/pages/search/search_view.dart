...
//   final String _previousSearch = '_';
...
//   const _SearchCategoryResults({Key? key, required this.textEditingController}) : super(key: key);
//    final TextEditingController textEditingController;
...
//     for (var searchResult in searchResult.entries) {
//       _updateResults(searchResult);
//     }
//   }

//   Future<Map<SearchType, RequestResponse<TrProductSearch>>> _fetchSearchResults(String search) async {
//     return await _trProductSearchService.requestTrProductSearch(search);
//   }

//   void _updateResults(MapEntry<SearchType, RequestResponse<TrProductSearch>> entry) {
...
//     SearchType type = entry.key;
//     TrProductSearch searchResult = entry.value.result!;
