...
class OngoingKnockoutService extends IService<OngoingKnockoutPosition?> {
  OngoingKnockoutService() : super(BehaviorSubject.seeded(null));

  Future<RequestResponse<OngoingKnockoutPosition>> enterOrExitOngoingOrder(
    BuyOrSell buyOrSell,
    OrderType orderType,
    ...
    var result = await DataRequestService.ongoingKnockoutDataRequestService.enterOrExitOngoingOrder(
      buyOrSell,
