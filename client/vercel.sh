...
then
  flutter build web --release --web-renderer canvaskit -t lib/main/main_prod.dart
else
  flutter build web --release --web-renderer canvaskit -t lib/main/main_staging.dart
fi